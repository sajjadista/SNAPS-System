...
<html>
	...
	<body>
		...
		<!-- Content -->
		<div class="mypurchase-searching container-fluid">
			<div class="mypurchase-searchbar">
				<form action="" method="post">
					<input class="mypurchase-searchbar-form-control me-2" type="text"
						placeholder="Search purchases">
				</form>
			</div>
		</div>

		<div class="cart-content container-fluid mb-5">
